...
ostream &operator<<(ostream &out, const Graph_test &g)
{
...
{
	return Edge_test(e.second, e.first);
}
...
void biccToArticulationPoints(const Graph_test &g, const vector< set<size_t> > &bicc, set<size_t> &articulationPoints)
{
